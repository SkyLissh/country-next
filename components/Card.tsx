export default function Card() {
	return (
		<li className="bg-white dark:bg-midnight-100 dark:text-slate-100 mb-10 rounded-lg shadow-lg transition-colors ease-in-out duration-300 border border-gray-300 dark:border-midnight-50 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 hover:border-blue-500 dark:hover:border-blue-500 hover:cursor-pointer">
			<img
